...
//<![CDATA[
        ...
        new nicEditor({fullPanel : true}).panelInstance('entry_body');
        new nicEditor({iconsPath : 'var/www/blog/assets/img/nicEditorIcons.gif'}).panelInstance('entry_body');
  ...
  //]]>
	...
	<div id="content-outer" class="clear"><div id="content-wrapper">
		...
		<div id="content"><div class="col-one">
			...
			<textarea rows="16" cols="80%" name="entry_body" id="entry_body" style="width: 600px; height: 300px;" style="resize:none;"></textarea></p>
